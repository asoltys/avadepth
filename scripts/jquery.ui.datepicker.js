...
var datepicker = {
	...
	createToggleIcon : function(fieldid, containerid){
		...
		// PWGSC Modification for IRCAN Defect 5014
		// For icons (Next/Previous month, show date picker, etc..), 
		//move the title to the alt of the image
		objToggle = $('<a id="' + containerid +'-toggle" class="picker-toggle-hidden" href="javascript:;" title="' + this.dictionary.showText + fieldLabel + '"><img src="' + Utils.getSupportPath() + "/datepicker/icon.png"+ '" alt="' + this.dictionary.showText + fieldLabel + '"/></a>');
