...
var locationExtents={
	...
	'FPORT':{'Lat':{'min':6307323,'max':6309424},'Lon':{'min':-13683400,'max':-13680592}}
  };
...
avaSurvey={
	initMap:function() {
		...
		var encstyle=new OpenLayers.Style({fillColor: '#dd0000',fillOpacity:0.0,strokeColor:'#dd0000',strokeWidth:1.0,title:'${name}'});
