...
if (!(typeof avaIFaceJS === 'undefined')) {
    ...
    avaIFaceJS.pwl_func = {
       ...
       */
        ...
        updateReportTitle: function() {
            ...
            var report_title_main = avaIFaceJS.pwl_func.report_title1 + " Fraser River - " + avaIFaceJS.pwl_func.report_title2;
            var report_title_2 = "For " + moment($('#pwl_date').val()).format("MMM D, YYYY") + " at " + avaIFaceJS.pwl_func.static_interval + " Intervals";
            var report_title_3 = "";
            var report_title_4 = "River Discharge @ Hope " + $('#flowRate').val() + " m\u00B3/s (" + translate_flow() + ")";
            return avaIFaceJS.reportWindow.addTitle(report_title_main,
                                                    report_title_2,
                                                    report_title_3,
                                                    report_title_4);
        },
    ...
    avaMapDetJS.pwl_func = {
        init: function() {
            ...
            avaMapDetJS.pwl_func.kml.events.on({
                'featureselected': avaMapDetJS.pwl_func.selectMarker
            });
